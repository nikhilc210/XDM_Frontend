...
export default function NewsLayout({ mainNews, ads }) {
            ...
            <div className="max-w-7xl mx-auto p-4">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div className="lg:col-span-4 space-y-6">
                  ...
                  {mainNews.slice(0, 2).map((item, index) => {
                    return (
                      <a
                      ...
                      >
                        <div className="bg-white">
                          ...
                          <div className="text-center">
                            <span className="text-red-500 text-sm font-medium mb-4">
                ...
                <div className="lg:col-span-4 space-y-4">
                  {mainNews.slice(3, 10).map((_, index) => (
                  ...
                  <div className="bg-white">
                    ...
                    <div className="p-4">
                      <div className="grid grid-cols-2 gap-4">
                        {mainNews.slice(11, 13).map((item, index) => {
                          return (
          ...
          <div className="bg-white px-4 py-6 space-y-6">
            ...
            {mainNews.slice(0, 2).map((item, index) => (
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h2 className="text-sm font-bold text-black mb-2 leading-tight">
                      {item.headline}
                    </h2>
            ...
            {middle?.redirectUrl && (
              <div className="flex justify-center">
                <a href={middle.redirectUrl} target="_blank" rel="noreferrer">
                  <Image
            ...
            <div className="space-y-4">
              {mainNews.slice(3, 10).map((item, index) => (
                <a href={`/newsDetail/${item._id}`} key={index}>
                  <div className="flex items-start border-b pb-4">
                    <Image
                      ...
                      width={64}
                      height={48}
                      className="mr-3 rounded object-cover flex-shrink-0"
                      unoptimized
                    />
                    <div className="flex-1">
            ...
            {top?.redirectUrl && (
              <div className="flex justify-center">
                <a href={top.redirectUrl} target="_blank" rel="noreferrer">
                  <Image
                    src={top.mobileImageUrl || "/placeholder-ad.svg"}
                    alt="top ad"
                    width={300}
                    height={250}
                    unoptimized
            ...
            {/* Section 5: Small Grid News */}
            <div className="grid grid-cols-1 gap-6">
              {mainNews.slice(11, 13).map((item, index) => (
                <a href={`/newsDetail/${item._id}`} key={index}>
                  <div className="flex items-start border-b pb-4">
                    <div className="relative w-20 h-16 mr-3">
                      <Image
                        src={item.newsImageUrl || "/placeholder.svg"}
                        alt="thumbnail"
                        fill
